---
title: "Getting Started with brapiR2"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with brapiR2}
...
Every function takes `con` as its first argument. No global state is modified.
...
[QBMS](https://icarda-git.github.io/QBMS/) is a well-established R package for
BrAPI access that has been widely adopted in the breeding community. brapiR2 and
QBMS are **complementary tools designed for different workflows**.
...
reproducible scripts, pipelines, or when you need genotypic data and caching.
Many users use both.
