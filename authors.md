...
Source:
[`inst/CITATION`](https://github.com/josh45-source/brapiR2/blob/main/inst/CITATION)

Ayo J (2026). *brapiR2: A Tidyverse-Native Client for BrAPI v2*. R
package version 0.1.0, <https://github.com/josh45-source/brapiR2>.

    @Manual{,
      title = {brapiR2: A Tidyverse-Native Client for BrAPI v2},
